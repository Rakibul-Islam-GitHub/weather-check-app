/**
 * @copyright Rakibul 2023 All rights reserved
 * @author  <rakibulislam.cse21@gmail.com>
 * @Linkedin  https://linkedin.com/in/rakibul21
 */

'use strict';

const API_KEY= '957f632d866171f2c36adfb983e594db';
...
async function getLocation(search) {
    let locationFetch = await fetch(`https://api.openweathermap.org/geo/1.0/direct?q=${search}&limit=3&appid=957f632d866171f2c36adfb983e594db`, {mode: 'cors'});
...
async function updateAfterSearch(city, country, lat, lon) {
    const getweatherData= await fetchApi(apiUrl.getDefaultWeather(lat, lon), function callback (data){
        ...
        updateViewDisplay({country:`${city +', '+country}`, lat, lon}, data)
